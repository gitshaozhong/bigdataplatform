...
import com.dhc.core.aop.SecurityLogAspect;
...
public class SecurityUtils {
    ...
    public static synchronized void putUserToSession(HttpServletRequest request, User user) {
        ...
        System.out.println("新建的sessionid:"+sessionId);
        ...
        System.out.println("放入session前，数量为  "+SecurityConstants.sessionInfoMap.size());
        SecurityConstants.sessionInfoMap.put(sessionId, sessionInfo);
        System.out.println("放入session后，数量为  "+SecurityConstants.sessionInfoMap.size());
    }
...
//            logger.error(e.getMessage(),e);
    ...
    public static synchronized void removeUserFromSession(String sessionId, boolean saveLog,SecurityType securityType) {
        if (StringUtils.isNotBlank(sessionId)) {
            ...
            System.out.println("删除session前，数量为  "+SecurityConstants.sessionInfoMap.size());
            ...
            if(session==null){System.out.println("session为空");
