 ...
 */
package com.dhc.core.aop;

import com.dhc.common.orm.hibernate.DefaultEntityManager;
import com.dhc.common.utils.browser.BrowserType;
import com.dhc.common.utils.browser.BrowserUtils;
...
import com.dhc.modules.sys.web.LoginController;
...
public class SecurityLogAspect {
     ...
     * @param joinPoint 切入点
     */
    @After("execution(* com.dhc.modules.sys.web.LoginController.login(..))")
     ...
     * @param joinPoint 切入点
     */
    @Before("execution(* com.dhc.modules.sys.web.LoginController.logout(..))")
