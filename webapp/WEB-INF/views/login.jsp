...
<head>
    <style type= "text/css" >
        ...
        div#header {background-color:#F0F0F0;height:130px;
            }


        div#menu{font-size:14px;background-image:url(${ctxStatic}/img/login_img/login2.jpg
        );width:100%;height:400px;background-size:100%100%;
        }
    </style>
    <title>用户登录</title>
...
<body>
<div id="header">
    <img src ="${ctxStatic}/img/login_img/5.png" align ="left";style="position:absolute;top:50%;">
    <h1 style="font-size: 45px;color:#ff4c4c;position: absolute;left: 0px" >下一代通信系统理论与技术研究室<p style="font-size: 30px">大数据分析系统</p></h1>
</div>

<div id="menu" style="padding-top: 120px;">
    <div class="form-div" id="login_div">
            ...
            <form id="loginForm" name="loginForm" style="margin-top: 20px" >
            <table>
                <tr>
                <td>
            ...
            <input type="checkbox" id="autoLogin" class="chk_1" /><label for="autoLogin"></label><font  >自动登录</font>
                ...
                <div class='bottons'>
                    <input  value="登 录" id="login_linkbutton"  type="submit" onclick="login();" href="#"  
                       style="margin-left: 130px;width: 210px;">
                </div>
