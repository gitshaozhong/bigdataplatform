...
<head>
    ...
    <style type="text/css">
        .login_label {display: inline-block;text-align: right;width: 76px;font-size: 14px;color: #000D0D;}
...
<body background="${ctxStatic}/img/background.jpg" style=" opacity:0.75;">
    <div id="login_div" align="center" style="margin-top: 200px;" >
        <div class="easyui-panel" title="用户登录" align="center" style="width:500px;padding:20px 30px 20px 30px;background-color:#eeeeee;">
        <div class="loginTitle" style="text-align: center; height: 55px; line-height: 55px;  ">山西移动IP地址管理系统</div>
            <form id="loginForm" method="post" novalidate>
                ...
                <div style="padding: 5px;">
                    ...
                    <label for="rememberPassword" style="margin-left: 76px;"><input id="rememberPassword" type="checkbox"/><font color=#000D0D>记住密码</font></label>
                    <label for="autoLogin"><input id="autoLogin" type="checkbox"/><font color=#000D0D>自动登录</font></label>
                </div>
                <div>
